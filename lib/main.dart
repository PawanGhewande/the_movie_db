...
import 'package:the_movie_db/pages/MovieDetails.dart';
import 'package:the_movie_db/pages/MyHome.dart';
    ...
    return Provider(
        ...
        child: Navigator(
          ...
          pages: stack.items.asMap().entries.map((e) {
            ...
            if (configuration.isHomeDetails)
              return MaterialPage(
                  key: key,
                  child: MovieDetail(
                    movie: configuration.movie,
                  ));
          }).toList(),
